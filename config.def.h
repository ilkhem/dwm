...
static const char *fonts[]          = {"monospace:size=11", "FontAwesome 5 Free Solid:size=11"};
...
static const char col_teal[]        = "#02d1b8";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_orange,  col_pink },
    ...
    [SchemeInfoSel]  = { col_teal, col_gray1,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
...
static const char *mail[]     = { TERMINAL, "-e", "neomutt", NULL };
...
static Key keys[] = {
	...
	{ 0, XF86XK_AudioStop,		spawn,		SHCMD("playerctl --player=spotify,%any stop") },
